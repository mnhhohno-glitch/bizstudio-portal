...
◆ 推薦コメント（3〜5行以内）
この求人と求職者の相性を、求職者本人に伝える文体で簡潔に記載。

【文体ルール】
- 「〜の経験が活かせます」「〜の点で希望に合っています」のように、求職者に語りかける表現で書く
- 「推薦すべき」「提案する」「確認した上で」「最優先」等のCA内部向け表現は絶対に使わない
- 「あなた」ではなく「○○さん」（求職者名）を使う
- マッチするポイントを具体的に伝え、前向きな印象を与える
- 懸念点は書かない（別途面談で伝える）
