...
◆ おすすめポイント（本人向け）
{求職者名}さんにとってこの求人がおすすめな理由を、求職者本人に語りかける文体で簡潔に記載。
マイページに表示される内容なので、ポジティブな訴求のみに徹すること。

【本人向けの文体ルール】
- 「〜の経験が活かせます」「〜がマッチしています」「〜にチャレンジできる環境です」「〜というご希望に合致しています」のように、前向きな表現で書く
- 求職者名は「○○さん」で統一する。「あなた」は使わない
- ネガティブ表現は一切禁止：「ただし」「しかし」「懸念」「注意」「不足」「未達」「難しい」「厳しい」等は使わない
- マッチするポイント・活かせる経験・成長機会を具体的に伝える
- 3〜5行（150文字程度）以内
