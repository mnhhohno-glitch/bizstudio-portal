...
export default function SystemForm({ systems }: { systems: SystemRow[] }) {
  ...
  return (
    <>
      ...
      {/* システム一覧テーブル */}
      <div className="mt-6 overflow-x-auto rounded-xl border border-[#E5E7EB]">
        <table className="min-w-full divide-y divide-[#E5E7EB] text-[14px]">
          <thead className="bg-[#F5F7FA]">
            <tr>
              <th className="whitespace-nowrap px-4 py-3 text-left font-medium text-[#374151]">並び</th>
              <th className="whitespace-nowrap px-4 py-3 text-left font-medium text-[#374151]">名前</th>
              <th className="whitespace-nowrap px-4 py-3 text-left font-medium text-[#374151]">状態</th>
              <th className="whitespace-nowrap px-4 py-3 text-left font-medium text-[#374151]">URL</th>
              <th className="whitespace-nowrap px-4 py-3 text-left font-medium text-[#374151]">操作</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#E5E7EB] bg-white">
            ...
            {systems.length === 0 && (
              <tr>
                <td colSpan={5} className="px-4 py-8 text-center text-[#374151]/60">
                  システムがまだ登録されていません
                </td>
              </tr>
            )}
