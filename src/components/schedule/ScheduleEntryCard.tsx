...
export default function ScheduleEntryCard({
  ...
  return (
    <div className={`group flex rounded-lg overflow-hidden ${isActive ? "bg-blue-50 ring-1 ring-blue-200" : "bg-[#F9FAFB]"} ${isCompleted ? "opacity-50" : ""}`}>
      {/* Checkbox */}
      {canComplete && entryId && (
        ...
        {canEdit && entryId && (
          <div className="shrink-0 flex gap-0.5 opacity-0 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="text-gray-300 hover:text-[#2563EB] p-0.5"
              title="編集"
            >
