...
export type ExternalConditionPayload = {
  ...
  area: { mode: string; regions: string[]; prefectures: string[] };
 ...
 */
export function toExternalArea(mode: string, prefectures: string[]): ExternalConditionPayload["area"] {
...
export function toExternalCondition(c: ExternalConditionRow): ExternalConditionPayload {
  ...
  return {
    ...
    area: toExternalArea(c.areaMode, c.prefectures),
